...
public class DudeRadFull extends DudeAbstract {

    public DudeRadFull(String id, Point position, List<PImage> images, int animationPeriod, int actionPeriod, int resourceLimit) {
    ...
    public boolean transform(
            ...
            ImageStore imageStore)
    {
        DudeRadNotFull miner = new DudeRadNotFull(this.id,
